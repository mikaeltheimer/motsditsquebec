...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MotDit.top_photo'
        db.add_column(u'motsdits_motdit', 'top_photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='top_photo', null=True, to=orm['motsdits.Photo']),
                      keep_default=False)

        # Adding field 'MotDit.top_avis'
        db.add_column(u'motsdits_motdit', 'top_avis',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='top_avis', null=True, to=orm['motsdits.Avis']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MotDit.top_photo'
        db.delete_column(u'motsdits_motdit', 'top_photo_id')

        # Deleting field 'MotDit.top_avis'
        db.delete_column(u'motsdits_motdit', 'top_avis_id')
