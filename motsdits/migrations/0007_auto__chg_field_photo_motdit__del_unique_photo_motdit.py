...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Photo', fields ['motdit']
        db.delete_unique(u'motsdits_photo', ['motdit_id'])


        # Changing field 'Photo.motdit'
        db.alter_column(u'motsdits_photo', 'motdit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['motsdits.MotDit']))

    def backwards(self, orm):

        # Changing field 'Photo.motdit'
        db.alter_column(u'motsdits_photo', 'motdit_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['motsdits.MotDit'], unique=True))
        # Adding unique constraint on 'Photo', fields ['motdit']
        db.create_unique(u'motsdits_photo', ['motdit_id'])
    ...
    models = {
        ...
        u'motsdits.photo': {
            ...
            'motdit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photo'", 'to': u"orm['motsdits.MotDit']"}),
