...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'motsdits_userprofile', 'photo')

        # Deleting field 'UserProfile.city'
        db.delete_column(u'motsdits_userprofile', 'city')

        # Deleting field 'UserProfile.province'
        db.delete_column(u'motsdits_userprofile', 'province')

        # Deleting field 'UserProfile.country'
        db.delete_column(u'motsdits_userprofile', 'country')

        # Deleting field 'UserProfile.lat'
        db.delete_column(u'motsdits_userprofile', 'lat')

        # Deleting field 'UserProfile.lng'
        db.delete_column(u'motsdits_userprofile', 'lng')

        # Deleting field 'UserProfile.description'
        db.delete_column(u'motsdits_userprofile', 'description')
    ...
    models = {
        ...
        u'motsdits.opinion': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.utcnow'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True'}),
            'dislikes': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'dislikes'", 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
