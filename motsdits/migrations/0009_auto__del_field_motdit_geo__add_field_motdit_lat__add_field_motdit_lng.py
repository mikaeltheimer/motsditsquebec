...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MotDit.lat'
        db.add_column(u'motsdits_motdit', 'lat',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'MotDit.lng'
        db.add_column(u'motsdits_motdit', 'lng',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MotDit.lat'
        db.delete_column(u'motsdits_motdit', 'lat')

        # Deleting field 'MotDit.lng'
        db.delete_column(u'motsdits_motdit', 'lng')
