...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MotDit.category'
        db.add_column(u'motsdits_motdit', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='motdit', null=True, to=orm['motsdits.Category']),
                      keep_default=False)

        # Removing M2M table for field category on 'MotDit'
        db.delete_table(db.shorten_name(u'motsdits_motdit_category'))

        # Adding M2M table for field subfilter on 'MotDit'
        m2m_table_name = db.shorten_name(u'motsdits_motdit_subfilter')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('motdit', models.ForeignKey(orm[u'motsdits.motdit'], null=False)),
            ('subfilter', models.ForeignKey(orm[u'motsdits.subfilter'], null=False))
        ))
        db.create_unique(m2m_table_name, ['motdit_id', 'subfilter_id'])


        # Changing field 'Subfilter.subfilter_type'
        db.alter_column(u'motsdits_subfilter', 'subfilter_type', self.gf('django.db.models.fields.CharField')(max_length=6))

    def backwards(self, orm):
        # Deleting field 'MotDit.category'
        db.delete_column(u'motsdits_motdit', 'category_id')
        ...
        # Removing M2M table for field subfilter on 'MotDit'
        db.delete_table(db.shorten_name(u'motsdits_motdit_subfilter'))


        # Changing field 'Subfilter.subfilter_type'
        db.alter_column(u'motsdits_subfilter', 'subfilter_type', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'motsdits.motdit': {
            ...
            'subfilter': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'motdit'", 'symmetrical': 'False', 'to': u"orm['motsdits.Subfilter']"}),
