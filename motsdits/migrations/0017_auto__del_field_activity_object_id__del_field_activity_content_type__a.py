...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'motsdits_activity', 'object_id')

        # Deleting field 'Activity.content_type'
        db.delete_column(u'motsdits_activity', 'content_type_id')

        # Adding field 'Activity.motdit'
        db.add_column(u'motsdits_activity', 'motdit',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['motsdits.MotDit'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Activity.opinion'
        db.add_column(u'motsdits_activity', 'opinion',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['motsdits.Opinion'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Activity.photo'
        db.add_column(u'motsdits_activity', 'photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['motsdits.Photo'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Activity.object_id'
        db.add_column(u'motsdits_activity', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Activity.content_type'
        raise RuntimeError("Cannot reverse this migration. 'Activity.content_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Activity.content_type'
        db.add_column(u'motsdits_activity', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Deleting field 'Activity.motdit'
        db.delete_column(u'motsdits_activity', 'motdit_id')

        # Deleting field 'Activity.opinion'
        db.delete_column(u'motsdits_activity', 'opinion_id')

        # Deleting field 'Activity.photo'
        db.delete_column(u'motsdits_activity', 'photo_id')
    ...
    models = {
        ...
        u'motsdits.activity': {
            ...
            'opinion': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['motsdits.Opinion']", 'null': 'True', 'blank': 'True'}),
