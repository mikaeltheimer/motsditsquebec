...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('motsdits_avis', 'motsdits_opinion')


    def backwards(self, orm):
        db.rename_table('motsdits_opinion','motsdits_avis') 
    ...
    models = {
        ...
        u'motsdits.motdit': {
            ...
            'top_opinion': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'top_opinion'", 'null': 'True', 'to': u"orm['motsdits.Opinion']"}),
