...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Subfilter'
        db.create_table(u'motsdits_subfilter', (
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['motsdits.Category'])),
        ))
        db.send_create_signal(u'motsdits', ['Subfilter'])

        # Deleting field 'Category.parent'
        db.delete_column(u'motsdits_category', 'parent_id')


    def backwards(self, orm):
        # Deleting model 'Subfilter'
        db.delete_table(u'motsdits_subfilter')

        # Adding field 'Category.parent'
        db.add_column(u'motsdits_category', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['motsdits.Category'], null=True, blank=True),
                      keep_default=False)
