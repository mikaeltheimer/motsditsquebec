...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MotDit.created_by'
        db.alter_column(u'motsdits_motdit', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'UserGuide.created_by'
        db.alter_column(u'motsdits_userguide', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Category.created_by'
        db.alter_column(u'motsdits_category', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Activity.created_by'
        db.alter_column(u'motsdits_activity', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Tag.created_by'
        db.alter_column(u'motsdits_tag', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Opinion.created_by'
        db.alter_column(u'motsdits_opinion', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Subfilter.created_by'
        db.alter_column(u'motsdits_subfilter', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Photo.created_by'
        db.alter_column(u'motsdits_photo', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        ...
        u'motsdits.activity': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['motsdits.AppUser']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'motsdits.motdit': {
            ...
            'lng': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'recommendations': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'motdit_recommendation'", 'symmetrical': 'False', 'to': u"orm['motsdits.AppUser']"}),
        ...
        u'motsdits.opinion': {
            ...
            'approvals': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'approvals'", 'symmetrical': 'False', 'to': u"orm['motsdits.AppUser']"}),
            'approved': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.utcnow'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['motsdits.AppUser']", 'null': 'True'}),
            'dislikes': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'dislikes'", 'symmetrical': 'False', 'to': u"orm['motsdits.AppUser']"}),
        ...
        u'motsdits.photo': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['motsdits.AppUser']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'likes': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'photo_likes'", 'symmetrical': 'False', 'to': u"orm['motsdits.AppUser']"}),
