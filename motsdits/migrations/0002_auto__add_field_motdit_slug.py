...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MotDit.slug'
        db.add_column(u'motsdits_motdit', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='test', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MotDit.slug'
        db.delete_column(u'motsdits_motdit', 'slug')
