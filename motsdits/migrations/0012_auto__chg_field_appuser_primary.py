...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AppUser.primary'
        db.alter_column(u'motsdits_appuser', 'primary_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['motsdits.UserGuide'], null=True))

    def backwards(self, orm):

        # Changing field 'AppUser.primary'
        db.alter_column(u'motsdits_appuser', 'primary_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['motsdits.UserGuide']))
