...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field subfilters on 'MotDit'
        m2m_table_name = db.shorten_name(u'motsdits_motdit_subfilters')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field subfilters on 'MotDit'
        db.delete_table(db.shorten_name(u'motsdits_motdit_subfilters'))
