...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Opinion.score'
        db.add_column(u'motsdits_opinion', 'score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding M2M table for field dislikes on 'Opinion'
        m2m_table_name = db.shorten_name(u'motsdits_opinion_dislikes')
    ...
    def backwards(self, orm):
        # Deleting field 'Opinion.score'
        db.delete_column(u'motsdits_opinion', 'score')

        # Removing M2M table for field dislikes on 'Opinion'
        db.delete_table(db.shorten_name(u'motsdits_opinion_dislikes'))
