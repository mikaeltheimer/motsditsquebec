...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'motsdits_user', 'facebook',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.twitter'
        db.add_column(u'motsdits_user', 'twitter',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.website'
        db.add_column(u'motsdits_user', 'website',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'motsdits_user', 'facebook')

        # Deleting field 'User.twitter'
        db.delete_column(u'motsdits_user', 'twitter')

        # Deleting field 'User.website'
        db.delete_column(u'motsdits_user', 'website')
