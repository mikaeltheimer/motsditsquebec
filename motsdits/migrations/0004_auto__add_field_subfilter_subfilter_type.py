...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subfilter.subfilter_type'
        db.add_column(u'motsdits_subfilter', 'subfilter_type',
                      self.gf('django.db.models.fields.CharField')(default='type', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subfilter.subfilter_type'
        db.delete_column(u'motsdits_subfilter', 'subfilter_type')
    ...
    models = {
        ...
        u'motsdits.subfilter': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'null': 'True'}),
            'subfilter_type': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        u'motsdits.tag': {
